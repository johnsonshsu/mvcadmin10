...
namespace mvcadmin10.Models
{
    public class z_sqlUsers : DapperSql<Users>
    {
        public z_sqlUsers()
        {
            ...
            DropDownValueColumn = "Users.UserNo";
            DropDownTextColumn = "Users.UserName + ' (' + Users.RoleNo + ')'";
            DropDownOrderColumn = "Users.UserNo ASC";
...
Users.CodeNo, vi_CodeUser.CodeName, Users.EmpNo, Employees.EmpName,
Users.RoleNo, Roles.RoleName, Users.GenderCode, 
...
LEFT OUTER JOIN Employees ON Users.EmpNo = Employees.EmpNo 
...
";
        ...
        public override List<string> GetSearchColumns()
        {
            ...
            SearchColumns.Add("Employees.EmpName");
...
";
        ...
        /// <param name="model">重設密碼資料</param>
        /// <returns></returns>
        public string ResetPasswordUpdate(vmResetPassword model)
        {
            using var cryp = new CryptographyService();
            using var dpr = new DapperRepository();
            string str_code = "";
        ...
        public string ResetPasswordConfirm(string validateCode)
        {
            ...
            if (userData != null)
            {
                ...
                else
                {
                    ...
                    parm.Add("IsValid", true);
                    dpr.Execute(sql_query, parm);
                    str_value = "您的新密碼驗證完成，請下次登入時使用您設定的新密碼登入系統!!";
                }
            }
            else
            { str_value = "查無此驗證碼"; }
