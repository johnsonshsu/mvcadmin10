...
namespace mvcadmin10.Areas.Mis.Controllers
{
    ...
    /// </summary>
    [Area("UHOM")]
    public class UHOMP004_ProductController : BaseAdminController
    {
        /// <summary>
        /// 控制器建構子
        /// </summary>
        ...
        public UHOMP004_ProductController(IConfiguration configuration, dbEntities entities)
        {
            db = entities;
        ...
        public ActionResult Index(int id = 1)
        {
            ...
            //取得資料列表集合
            using var sqlData = new z_sqlPhotos();
        ...
        {
            using var sqlData = new z_sqlPhotos(); return sqlData.Delete(id);
        }
        ...
        public ActionResult Upload(int id)
        {
            ...
            ActionService.SetSubActionName("產品資訊");
            ActionService.SetActionCardSize(enCardSize.Medium);
            return View();
        }
        ...
        public ActionResult Upload(IFormFile file)
        {
            ...
            string errorMsg = imageService.UploadImage(file, "portfolios", $"{data.FolderName}.jpg");
