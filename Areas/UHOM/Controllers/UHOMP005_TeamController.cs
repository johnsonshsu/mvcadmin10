...
namespace mvcadmin10.Areas.Mis.Controllers
{
    ...
    /// </summary>
    [Area("UHOM")]
    public class UHOMP005_TeamController : BaseAdminController
    {
        /// <summary>
        /// 控制器建構子
        /// </summary>
        ...
        public UHOMP005_TeamController(IConfiguration configuration, dbEntities entities)
        {
            db = entities;
        ...
        [Login(RoleList = "User")]
        [Security(Mode = enSecurityMode.AddEdit)]
        public IActionResult CreateEdit(Teams model)
        {
        ...
        {
            using var sqlData = new z_sqlTeams(); return sqlData.Delete(id);
        }
        ...
        public ActionResult Upload(int id)
        {
            ...
            ActionService.SetSubActionName("服務團隊");
            ActionService.SetActionCardSize(enCardSize.Medium);
            return View();
        }
        ...
        public ActionResult Upload(IFormFile file)
        {
            ...
            string errorMsg = imageService.UploadImage(file, "portfolios", $"{data.TeamNo}.jpg");
