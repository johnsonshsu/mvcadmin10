...
namespace mvcadmin10.Areas.Mis.Controllers
{
    ...
    /// </summary>
    [Area("UHOM")]
    public class UHOMP001_CarouselController : BaseAdminController
    {
        /// <summary>
        /// 控制器建構子
        /// </summary>
        ...
        public UHOMP001_CarouselController(IConfiguration configuration, dbEntities entities)
        {
            db = entities;
        ...
        public ActionResult Index(int id = 1)
        {
            ...
            //取得資料列表集合
            using var sqlData = new z_sqlCarousels();
        ...
        [Login(RoleList = "User")]
        [Security(Mode = enSecurityMode.AddEdit)]
        public IActionResult CreateEdit(Carousels model)
        {
        ...
        {
            using var sqlData = new z_sqlCarousels(); return sqlData.Delete(id);
        }
        ...
        public ActionResult Upload(int id)
        {
            ...
            ActionService.SetSubActionName("輪播圖片");
            ActionService.SetActionCardSize(enCardSize.Medium);
            return View();
        }
        ...
        public ActionResult Upload(IFormFile file)
        {
            ...
            string errorMsg = imageService.UploadImage(file, "carousels", $"{data.ImageUrl}");
