...
namespace mvcadmin10.Areas.Mis.Controllers
{
    ...
    /// </summary>
    [Area("MUSR")]
    public class MUSRP002_MisController : BaseAdminController
    {
        /// <summary>
        /// 控制器建構子
        /// </summary>
        ...
        public MUSRP002_MisController(IConfiguration configuration, dbEntities entities)
        {
            db = entities;
        ...
        public ActionResult Index(int id = 1)
        {
            ...
            var model = modelData.Where(m => m.RoleNo == SessionService.BaseNo).ToPagedList(SessionService.PageMaster, pageSize);
        ...
        /// 重設使用者密碼
        /// </summary>
        /// <param name="id">要重設密碼的使用者ID</param>
        [HttpGet]
        [Login(RoleList = "Mis")]
